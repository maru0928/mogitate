...
class ProductTableSeeder extends Seeder
{
    ...
    $param = [
      ...
      'image' => 'src/storage/strawberry.png'
    ];
    DB::table('products')->insert($param);
   $param = [
      'name' => 'オレンジ',
    ...
    $param = [
      ...
      'image' => 'src/storage/watermelon.png'
    ];
    DB::table('products')->insert($param);
    $param = [
      'name' => 'ピーチ',
    ...
    $param = [
      ...
      'image' => 'src/storage/pineapple.png'
    ];
    DB::table('products')->insert($param);
   $param = [
      'name' => 'ブドウ',
